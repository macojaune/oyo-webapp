export default {
  ...
  GET_DEVICE_POSITION_REQUEST: 'GET_DEVICE_POSITION_REQUEST',
  GET_DEVICE_POSITION_SUCCESS: 'GET_DEVICE_POSITION_SUCCESS',
  GET_DEVICE_POSITION_FAILURE: 'GET_DEVICE_POSITION_FAILURE',
};
